...
public class BirthdayGreeterShould {
    ...
    public void should_send_greeting_email_to_employee() {
        ...
        String expectedMessage = String.format("Happy birthday, dear %s!", employee.getFirstName());
        Email expectedEmail = new Email(employee.getEmail(), "Happy birthday!", expectedMessage);
